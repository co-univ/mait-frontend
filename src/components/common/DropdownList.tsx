	...
	const renderDropdownItem = (item: Content | IconContent, i: number) => {
		...
		return (
			...
			>
				...
				<p className="select-none truncate text-left typo-body-small text-gray-30 group-hover:text-alpha-black100">
					{text}
				</p>
			</button>
		);
	...
	return (
		...
		>
			<div className="w-full p-1">
				<p className="select-none px-[0.5rem] py-[0.28rem] typo-body-small text-alpha-black100">
					{group}
				</p>
			</div>
