...
const DropdownSelectBox = ({
  ...
  return (
    <button
      className="bg-alpha-white-100 group flex h-[47px] w-full items-center justify-between rounded-md border border-gray-20 p-3 focus:border-primary-50"
      type="button"
      onClick={handleButtonClick}
    >
      <p className="group-focus:text-alpha-black-100 text-[15px] font-medium text-gray-30">
        {text}
      </p>
      {isOpen ? (
