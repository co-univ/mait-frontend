...
const Header = ({ isSideBarOpen, setIsSideBarOpen }: HeaderProps) => {
	...
	const renderHeaderShort = () => {
		...
		return (
			<div className="fixed left-0 top-0 flex h-24 w-full place-content-between items-center bg-alpha-white-100 p-8 transition-all duration-300 ease-in-out delay-100">
				<div className="flex items-center gap-[4.5rem] ml-[17.5rem]">
					<HistoryController />
				</div>
