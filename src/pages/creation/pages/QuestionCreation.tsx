					...
					<div className="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
						...
						<div className="flex flex-wrap gap-4">
							<button
								...
								className="flex items-center gap-2 px-4 py-2 bg-purple-50 text-purple-600 rounded-md text-sm font-medium hover:bg-purple-100 border border-purple-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
							>
								<Plus size={16} />
								객관식 추가
							</button>
							<button
								...
								disabled={createQuestion.isPending}
								className="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-600 rounded-md text-sm font-medium hover:bg-green-100 border border-green-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
							>
								<Plus size={16} />
								주관식 추가
							</button>
							<button
								...
								disabled={createQuestion.isPending}
								className="flex items-center gap-2 px-4 py-2 bg-orange-50 text-orange-600 rounded-md text-sm font-medium hover:bg-orange-100 border border-orange-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
							>
								<Plus size={16} />
								순서배치 추가
							</button>
							<button
								...
								disabled={createQuestion.isPending}
								className="flex items-center gap-2 px-4 py-2 bg-yellow-50 text-yellow-600 rounded-md text-sm font-medium hover:bg-yellow-100 border border-yellow-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
							>
								<Plus size={16} />
								빈칸 문제 추가
							</button>
								...
								<div className="absolute top-4 right-4 flex items-center gap-2">
									{!question.isSaved ? (
										...
										<button
											...
											className="flex items-center gap-2 px-3 py-1 bg-green-50 text-green-600 border border-green-200 hover:bg-green-100 rounded-md text-xs font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
										>
											<Save size={14} />
											저장
										</button>
										...
										// 저장된 문제: 저장 완료 표시
										<div className="flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-600 border border-blue-200 rounded-md text-xs font-medium">
											<Save size={14} />
											저장됨
										</div>
									)}
