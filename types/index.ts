...
export type ApiResponseCurrentQuestionApiResponse =
...
export type ApiResponseUserInfoApiResponse =
...
export type CurrentQuestionApiResponse =
	components["schemas"]["CurrentQuestionApiResponse"];
...
export type getUserInfo = components["schemas"]["getUserInfo"];
...
export type UsersMePath = paths["/api/v1/users/me"];
...
export type QuestionSetsQuestionSetIdLiveStatusCurrentQuestionPath =
	paths["/api/v1/question-sets/{questionSetId}/live-status/current-question"];
