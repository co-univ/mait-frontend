...
export type QuestionSetsQuestionSetIdLiveStatusRankCorrectPath = paths['/api/v1/question-sets/{questionSetId}/live-status/rank/correct'];
export type QuestionSetsQuestionSetIdLiveStatusCurrentQuestionPath = paths['/api/v1/question-sets/{questionSetId}/live-status/current-question'];
